...
-- 导出 yingjia 的数据库结构
DROP DATABASE IF EXISTS `yingjia`;
...
DROP TABLE IF EXISTS `business-dishes`;
...
DROP TABLE IF EXISTS `ingre-deshes`;
...
DROP TABLE IF EXISTS `menu-ingre_deshes`;
...
DROP TABLE IF EXISTS `type_allergen`;
...
DROP TABLE IF EXISTS `type_constitution`;
...
DROP TABLE IF EXISTS `type_dinnertime`;
...
DROP TABLE IF EXISTS `type_drink`;
...
DROP TABLE IF EXISTS `type_flavor`;
...
DROP TABLE IF EXISTS `type_mealtype`;
...
DROP TABLE IF EXISTS `type_motion`;
...
DROP TABLE IF EXISTS `type_plan`;
